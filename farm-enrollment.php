...
<body>
    <div class="hero-bg bg-dark technology farm-enrollment">
    ...
    <section class="pb-5">
        <div class="container p-5 w-75">
            ...
            <p>The tool also allows for Farmer Enrollment/capturing of bio-data and proper profiling of farmers and their production assets like land for access to financing.</p>
            <!-- <div class="mt-md-4">
